...
if __name__ == '__main__':
    ...
    with open(read_path, 'rb') as f:
        ...
        #data_o = PA(data_i, data_len, saida, media_buf, aA, bA) + PB(data_i, data_len, saida, media_buf, aB, bB)
        data_o = np.convolve(PA(data_i, data_len, saida, media_buf, aA, bA), PB(data_i, data_len, saida, media_buf, aB, bB))
